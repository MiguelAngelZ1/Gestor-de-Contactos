...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (formGasto) {
    formGasto.addEventListener('submit', (event) => {
      ...
      // Convierte el valor del monto a número: elimina cualquiera carácter que no sea dígito, coma o punto
      ...
      // Se llama a la función que agrega el gasto fijo, y luego se resetea el formulario
